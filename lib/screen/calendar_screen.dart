...
import 'package:hodorak/providers/calendar_provider.dart';
...
class CalendarScreen extends ConsumerWidget {
  ...
  Future<void> _selectMonth(BuildContext context, WidgetRef ref, DateTime currentMonth) async {
  ...
  Future<void> _exportData(BuildContext context, List<DailyAttendanceSummary> summaries) async {
    try {
      // Create CSV content
      String csvContent = 'Date,Total Employees,Present,Absent,Attendance Rate\n';
      
      for (final summary in summaries) {
        csvContent += '${_formatDate(summary.date)},'
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            onPressed: () => _selectMonth(context, ref, calendarState.selectedMonth),
  ...
  Widget _buildSummaryCard(BuildContext context, DailyAttendanceSummary summary) {
    ...
    return Card(
      ...
      child: ExpansionTile(
        leading: Container(
          ...
          height: 50,
          decoration: BoxDecoration(
            color: isGoodAttendance ? Colors.green.shade100 : Colors.orange.shade100,
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    _buildStatColumn('Total', summary.totalEmployees.toString(), Colors.blue),
                    _buildStatColumn('Present', summary.presentEmployees.toString(), Colors.green),
                    _buildStatColumn('Absent', summary.absentEmployees.toString(), Colors.red),
                  ],
                ),
                ...
                if (summary.employeeAttendances.isNotEmpty) ...[
                  ...
                  const SizedBox(height: 8),
                  ...summary.employeeAttendances.take(5).map((emp) => Padding(
